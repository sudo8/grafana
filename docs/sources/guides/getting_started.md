...
This guide will help you get started and acquainted with Grafana. To learn more about Grafana in general, To learn more about Grafana in general,，refer to [What is Grafana?]({{< relref "what-is-grafana.md" >}}).
